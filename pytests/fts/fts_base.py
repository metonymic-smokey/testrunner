...
class FTSBaseTest(unittest.TestCase):
    ...
    def __init_parameters(self):
        ...
        self.min_queries_per_shape = self._input.param("min_queries_per_shape",10)
    ...
    def generate_random_geoshape_queries(self,index,num_queries=1,sort=False):
        ...
        if self.query_shape != "":
            ...
            if min_queries_per_shape * len(shapes) >= num_queries  :
                while gen_queries <= len(shapes) * min_queries_per_shape:
                    print("\n\n length of gen queries ",gen_queries)
                    shape = shapes[gen_queries//min_queries_per_shape]
